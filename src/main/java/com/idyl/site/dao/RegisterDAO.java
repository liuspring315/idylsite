...
//		4摄影机构管理员
		...
		insertExtraSqlMap.put(UserTypeEnum.PHOTOGRAPHER.getCode(),"INSERT INTO photographer_extra (user_general_info_id,register_check_state) VALUES (:userGeneralInfoId,1)");
		insertExtraSqlMap.put(UserTypeEnum.STYLIST.getCode(),"INSERT INTO stylist_extra (user_general_info_id,register_check_state) VALUES (:userGeneralInfoId,1)");
		insertExtraSqlMap.put(UserTypeEnum.AGENCY.getCode(),"INSERT INTO agency_extra (user_general_info_id,register_check_state) VALUES (:userGeneralInfoId,1)");
	}
